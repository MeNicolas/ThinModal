/*Don't use this JS file: it's modified for work with the GitHub homepage*/
...
function modal(modal,style){
	...
	if(style == 1){
		$('#modal').html('<div id="modalHeader"><div id="modalTitle">'+$(modal).attr('title')+'</div><div id="modalClose" onclick="modalclose();">&times;</div></div>').append("This is my modal's content").fadeIn('fast');
		$('#overlay').fadeIn();
	}else{
		$('#modal').html("This is my modal's content").fadeIn('fast');
		$('#overlay').fadeIn();
	}
